...
Contains:
    ...
    * LoCoMo_Event_Binding_factual      - event-mode factual extraction
    * LoCoMo_Event_Binding_relational   - event-mode relational extraction
    * LoCoMo_Cross_Event_Consolidation  - cross-event summarization prompt
    * UPDATE_PROMPT                     - memory update/delete/ignore decision
    * EXTRACTION_PROMPTS                - the dispatch table used by OpenaiManager
"""
